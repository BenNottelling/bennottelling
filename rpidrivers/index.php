...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      ...
      <p>Your easy source for drivers and software for Windows 10 on the RPI</p>
    </div>
<!--    <div class="w3-third w3-container">
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h2 class="w3-text-teal">USB Drivers</h2>
	  <p>MCCI USB Drivers</p>
	  <a class="w3-button w3-black" href="http://rpidrivers.bennottelling.com/usb/index.php">Check out the USB driver page</a>
    </div>
<!--     <div class="w3-third w3-container">
     <p class="w3-border w3-padding-large w3-padding-32 w3-center">AD</p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-center">AD</p>
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
		<h2 class="w3-text-teal">VideoCore IV Drivers</h2>
	  <p>These don't do too much</p>
	  <a class="w3-button w3-black" href="http://rpidrivers.bennottelling.com/gpu/index.php">GPU Driver Page</a>
    </div>
<!--     <div class="w3-third w3-container">
     <p class="w3-border w3-padding-large w3-padding-32 w3-center">AD</p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-center">AD</p>
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
		<h2 class="w3-text-teal">Ethernet Drivers</h2>
	  <p>Best way to get internet on your pi ATM</p>
	  <a class="w3-button w3-black" href="http://rpidrivers.bennottelling.com/ethernet/index.php">Ethernet Driver Page</a>
    </div>
<!--     <div class="w3-third w3-container">
     <p class="w3-border w3-padding-large w3-padding-32 w3-center">AD</p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-center">AD</p>
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
		<h2 class="w3-text-teal">UEFI BIOS</h2>
	  <p>This allows 64bit OS's to boot on the PI, like, Windows 10</p>
	  <a class="w3-button w3-black" href="http://rpidrivers.bennottelling.com/uefi/index.php">UEFI BIOS Page</a>
    </div>
<!--     <div class="w3-third w3-container">
     <p class="w3-border w3-padding-large w3-padding-32 w3-center">AD</p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-center">AD</p>

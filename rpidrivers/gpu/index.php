...
$drivername = "Broadcom VideoCore IV";
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      ...
      <p>These drivers are based off of Microsoft's open source driver demo, currently they have a very small ammount of support for DirectX, but not enough to be useful. There is a branch with is supposed to support Direct2D rendering, which would in theory speed up the rendering of windows and reduce CPU usage, but it isn't really tested.</p>
    </div>
<!--    <div class="w3-third w3-container">
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
	  ...
	  <p>Last tested build <span id="sc1">1.0.19</span>, fails with error 43.</p>
    </div>
<!--     <div class="w3-third w3-container">
     <p class="w3-border w3-padding-large w3-padding-32 w3-center">AD</p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-center">AD</p>
...
<a class="w3-button w3-black" href="<?php echo $downurl; ?>">Driver Download</a>
<br>
<iframe src="http://tylerlh.github.com/github-latest-commits-widget/?username=woachk&repo=rpigpu&limit=LIMIT"
  allowtransparency="true" frameborder="0" scrolling="yes" width="702px" height="300px"></iframe>
  <!-- Pagination -->

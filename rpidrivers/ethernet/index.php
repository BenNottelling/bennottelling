...
$status = "9";
$notes = "Ethernet Drivers seem to work perfectly with no crashes or slow down. It is possible that there is extra CPU overhead that can be lowered, but overall they work great. Note, 3 B+ users will not see ethernet lights, 3 B users will";
$downurl7800 = "https://www.microchip.com/SWLibraryWeb/producttc.aspx?product=OBJ-LAN78xx-WINDOWS";
$downurl9500 = "https://www.microchip.com/SWLibraryWeb/producttc.aspx?product=OBJ-LAN95xx-WINDOWS";
$drivername = "LAN7515 and LAN9514 Ethernet Drivers";
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      ...
      <p>These drivers are closed source and come officaly from micorip, the manufacture and desinger of the ethernet controller on the Raspberry PI.</p>
	  <p>7800 is for the Raspberry Pi 3 B+ </p>
    </div>
<!--    <div class="w3-third w3-container">
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h2 class="w3-text-teal">Driver funcionality score:</h2>
      <p> <span id="sc<?php echo $status; ?>"><?php echo $status; ?>  (1-10)</span></p>
    </div>
<!--     <div class="w3-third w3-container">
     <p class="w3-border w3-padding-large w3-padding-32 w3-center">AD</p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-center">AD</p>
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h2 class="w3-text-teal">Driver notes:</h2>
      <p><?php echo $notes; ?></p>
    </div>
<!--     <div class="w3-third w3-container">
     <p class="w3-border w3-padding-large w3-padding-32 w3-center">AD</p>
...
<a class="w3-button w3-black" href="<?php echo $downurl7800; ?>">LAN7800 Driver Download</a>
<a class="w3-button w3-black" href="<?php echo $downurl9500; ?>">LAN9500 Driver Download</a>
  <!-- Pagination -->

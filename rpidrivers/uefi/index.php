...
$status = "8";
$notes = "Limited USB1, RTC, and NVRAM support. Rare incompatibility with keyboards (such as freezing before OS boot)";
$downurl = "https://github.com/andreiw/RaspberryPiPkg/tree/master/Binary/prebuilt";
$drivername = "RaspberryPiPkg (64 UEFI for RPI)";
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      ...
      <p>This is the UEFI that allows it all to happen, withouth this UEFI you could never be able to boot windows 10 on your Raspberry PI.</p>
    </div>
...
<br>
<iframe src="http://tylerlh.github.com/github-latest-commits-widget/?username=andreiw&repo=RaspberryPiPkg"
